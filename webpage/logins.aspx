<%@ Page Language="C#" AutoEventWireup="true" CodeFile="logins.aspx.cs" Inherits="webpage_logins" %>
       ...
       <div class="row">
         <div class="col-lg-4">   
          <label style="font-weight:normal">
            <input type="radio" id="students" name="radiotest" checked="checked" > 学生
          </label>  
        </div>
        <div class="col-lg-4">   
          <label style="font-weight:normal">
            <input type="radio" id="teacher"  name="radiotest" > 教师
          </label>  
       </div>
       <div class="col-lg-4">   
          <label style="font-weight:normal">
            <input type="radio" id="mgr" name="radiotest" > 管理员
          </label>  
      </div>
                    ...
                    if (data == "success")
                    {
                        switch(usertype)
                        {
                            case 1:
                                break;
                            case 2:
                                window.location.replace("tprofile.html");
                                break;
                            default:
                                break;
                        }                        
